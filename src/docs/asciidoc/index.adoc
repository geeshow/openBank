...
[[resources-interest-dto]]
=== 계좌 거래내역 조회

`GET` 요청을 사용해서 해당 계좌의 거래내역을 조회 할 수 있다.

operation::get-interest-dto[snippets='curl-request,http-request,http-response,response-body,response-fields,response-headers,links']
